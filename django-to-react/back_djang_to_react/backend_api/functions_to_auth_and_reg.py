from .models import UsersAuthorization, AccessTypes
from .serializer import UsersAuthorizationSerializer, UserAccessSerializer, AccessTypesSerializer
...
def ensure_default_access_type():
    """Гарантирует наличие стандартного типа доступа (ID=1)"""
